...
SCHEMA_USER_UPLOADS = get('SCHEMA_USER_UPLOADS', 'users_uploads')
WORKSPACE_USER_UPLOADS = get('WORKSPACE_USER_UPLOADS', 'users_uploads')
DATASTORE_USER_UPLOADS = get('DATASTORE_USER_UPLOADS', 'users_uploads')
